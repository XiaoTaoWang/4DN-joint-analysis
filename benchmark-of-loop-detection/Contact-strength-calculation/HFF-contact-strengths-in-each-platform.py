...
queue = [
    ...
    ('H3K4me3 PLAC-Seq', 'PLAC-HFFc6-H3K4me3-allReps.mcool'),
    ('CTCF ChIA-PET', 'ChIAPET-HFFc6-CTCF-allReps.mcool'),
    ('RNAPII ChIA-PET', 'ChIAPET-HFFc6-RNAPII-allReps.mcool'),
    ('SPRITE', 'SPRITE-HFFc6-allReps.mcool'),
    ('SPRITE_2_10', 'HFFc6.2_10.two_over_n.mcool')
]
...
joblib.dump(data, 'HFF.contact-strength.ICE.pkl')